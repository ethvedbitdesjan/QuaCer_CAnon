...
This repository contains code and resources for certifying knowledge comprehension abilities of Large Language Models (LLMs) during in-context learning, based on the paper **"Anonymous"**
...
- **Formal Probabilistic Guarantees:** LLMCert provides high-confidence bounds on the probability of correct LLM responses.
...
You can create your own `model_experiment.py` file to adapt LLMCert to a new LLM.  Your custom file should define two main functions:
